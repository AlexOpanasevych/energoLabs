...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../libs/database/release/ -ldatabase
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../libs/database/debug/ -ldatabase
