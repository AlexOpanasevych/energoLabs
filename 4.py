...
def electrical_voltage():
    ...
    btn_31 = Button(tab31, text='Обрати', height=1, font=('Rockwell', 10), command=choices_add)
    ...
    def choices_build():
        ...
        for item in all_graphs_electrical_voltage:
            ...
            for week, it in zip(('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'),
                                range(7)):
                x, y = [], []
            ...
            if len(all_graphs_electrical_voltage) > 1 and item == all_graphs_electrical_voltage[-1]:
                ...
                btn_99 = Button(tab31, text='Звіт', height=1, font=('Rockwell', 10), command=form_pdf3())
